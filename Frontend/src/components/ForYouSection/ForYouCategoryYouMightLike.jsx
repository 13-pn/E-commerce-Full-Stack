...
const ForYouCategoryYouMightLike = () => {
      ...
      const [Loading, setLoading] = useState(true)
        useEffect(() => {
          const fetchprod=async()=>{
            try{
            let res=await fetch("https://e-commerce-full-stack-63y6.onrender.com/api/products?limit=5")
  ...
  return (
   <div className='foryou-container  pt-4'>
       ...
       <div className='d-flex justify-content-between align-items-center px-2'>
         <h3 className='heading'>Category You might like</h3>
       </div>
...
export default ForYouCategoryYouMightLike